                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-md-12">
                                            ...
                                            <div className="invoice-view-topbar">
                                                <Link to="#" className="back-to"><i class="fas fa-chevron-left"></i> Back</Link>
                                            </div>
                                            <div className="create-ticket-top-btns">
                                                <Link to="#" className="ticket-cancel-btn">Cancel</Link>
                                                <Link to="#" className="ticket-btn ml-3">Create Ticket</Link>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="ticket-col-one">
                                                 <form action="">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-12 col-md-12">
                                                            <div className="form-group">
                                                                <label for="control-label">Vehicle Registration Number</label><br/>
                                                                <input type="number" name="form-control" id=""/>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-12 col-md-12">
                                                            <div className="form-group">
                                                        ...
                                                        <div className="col-lg-12 col-md-12">
                                                            <div className="form-group">
                                                                <label for="control-label">Send</label><br/>
                                                                <Link to="#" className="serch-bar"><i className="fa-solid fa-magnifying-glass"></i><input type="search" id="site-search" name="form-control"/></Link>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="cstmr-srchbox">
                                                            <div className="drvr_deta active">
                                                                <div className="drvrmain">
                                                                    <img src="./admin_assets/images/new-customers-list.png" className="new-customers-img" alt="new-customers-img"/>
                                                                ...
                                                                <div className="drvrcar">
                                                                    ...
                                                                    </svg><span>+44 334 2345</span>
                                                                </div>
                                                                <div className="cstmr-view-deta-eye">
                                                                    <Link to="#" className="uploaded-btn">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                            <path d="M7.9987 12C11.6806 12 14.6654 8 14.6654 8C14.6654 8 11.6806 4 7.9987 4C4.3168 4 1.33203 8 1.33203 8C1.33203 8 4.3168 12 7.9987 12Z" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                            <path d="M8.0013 9.33464C8.73768 9.33464 9.33464 8.73768 9.33464 8.0013C9.33464 7.26492 8.73768 6.66797 8.0013 6.66797C7.26492 6.66797 6.66797 7.26492 6.66797 8.0013C6.66797 8.73768 7.26492 9.33464 8.0013 9.33464Z" stroke="white"
                                                        ...
                                                        <div className="col-lg-12 col-md-12">
                                                            <div className="form-group">
                                                                ...
                                                                <select name="Vehicle" id="cars">
                                                                    <option value="Vehicle">Mercedes E220</option>
                                                                    <option value="Vehicle2">Mercedes E220</option>
                                                                    <option value="Vehicle3">Mercedes E220</option>
                                                                    <option value="Vehicle4">Mercedes E220</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-12 col-md-12">
                                                        ...
                                                        <div className="col-lg-12 col-md-12">
                                                            <div className="form-group">
                                                                <label for="control-label">Company Notes</label><br/>
                                        ...
                                        <div className="col-lg-5 col-md-5">
                                           ...
                                           <div className="pay-Sch-PP-one pay-Sch-PP-three ">
                                                ...
                                                <div className="pp-main-head">
                                                    <img src="./admin_assets/images/customer2.png" className="customer2-img" alt="customer2-img"/>
                                               ...
                                               <div className="frmmainbx">
                                                    ...
                                                    <div className="cstmr-details">
                                                        <form action="">
                                                            <div className="row frm-inner-row2">
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
                                                                        <label for="control-label">First Name</label>
                                                                        <br/>
                                                                        <input type="text" name="form-control" placeholder=""/>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <br/>
                                                                        <input type="email" name="form-control" placeholder=""/>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <input type="number" name="form-control" placeholder="+44" className="mg0"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <br/>
                                                                        <input type="number" name="form-control" placeholder=""/>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-6 col-md-6">
                                                                    <div className="form-group">
