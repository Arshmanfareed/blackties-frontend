                  ...
                  <div className="vehicle-tabs">
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                      <li className="nav-item" role="presentation">
                        <Link className="nav-link active" id="important-notices-tab" data-bs-toggle="tab" to="#important-notices" role="tab" aria-controls="important-notices" aria-selected="false">Important Notices</Link>
                      </li>
                      <li className="nav-item" role="presentation">
                        <Link className="nav-link" id="statistics-tab" data-bs-toggle="tab" to="#statistics" role="tab" aria-controls="statistics" aria-selected="false">Statistics</Link>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="tab-content" id="v-pills-tabContent">
                  <div className="tab-pane fade show active" id="important-notices" role="tabpanel" aria-labelledby="important-notices-tab">
                    <div className="row frm-inner-row admin-dash-frm">
                      <div className="col-md-6 brdr-r">
                          ...
                          <div className="row">
                            <div className="col-lg-4 col-md-4">
                              <div className="form-group">
                                <label for="control-label">Invoice</label>
                                <br/>
                            ...
                            <div className="col-lg-4 col-md-4">
                              <div className="form-group">
                                <label for="control-label">Driver</label>
                                <br/>
                                <input type="text" name="form-control"/>
                              </div>
                            </div>
                            ...
                            <table className="maintenance-table ds-table veh-history-tble adm-user-tble">
                              <thead>
                                <tr>
                                  ...
                                  <th>Driver <i className="fas fa-arrow-down"></i>
                                  </th>
                                  <th>VRN</th>
                                  <th>Amount</th>
                                  <th>Action</th>
                              ...
                              <tbody>
                                <tr>
                                  <td>001</td>
                                  <td>July 19, 2024</td>
                                  <td className="td-clr">Omar Benyoucef</td>
                                  <td>KM19 VUG</td>
                                  <td>£280</td>
                                  <td className="view-btn">
                                    <Link to="javascript:;" onClick={handleShow}>View</Link>
                                  </td>
                                </tr>
                                <tr>
                                  <td>002</td>
                          ...
                          <div className="veh-registration-table rigistration-tabl Maintenance-tble">
                            <table className="maintenance-table ds-table veh-history-tble adm-user-tble">
                              <thead>
                                <tr>
                                  <th>Customer ID</th>
                                  <th>Full Name <i className="fas fa-arrow-down"></i>
                                  </th>
                                  <th>Phone Number</th>
                      ...
                      <div className="col-md-6 brdr-r nopd-col">
                        <div className="unpd-inv">
                          <div className="unpd-inv-deta">
                            <h1>Unrented Vehicle</h1>
                          </div>
                          <div className="unpd-inv-v-btn">
                            <Link to="javascript:;">Go To Calendar</Link>
                          </div>
                        </div>
                        <div className="user-app-tabl">
                          <div className="veh-registration-table rigistration-tabl Maintenance-tble">
                            <table className="maintenance-table ds-table veh-history-tble adm-user-tble">
                              <thead>
                                <tr>
                                  <th>Vehicle <i className="fas fa-arrow-down"></i>
                                  </th>
                                  <th>VRN</th>
                              ...
                              <tbody>
                                <tr>
                                  <td className="td-clr">2019 Mercedes-Benz E Class)</td>
                                  <td>KM19 VUG</td>
                      ...
                      <div className="col-md-6 nopd-col">
                        <div className="unpd-inv">
                          <div className="unpd-inv-deta">
                            <h1>Outgoing</h1>
                          </div>
                  ...
                  <div className="tab-pane fade show" id="statistics" role="tabpanel" aria-labelledby="statistics-tab">
                    <div className="support-issue-head">
                      <h4>Statistics</h4>
                      <div className="statshead-cal">
                        <div className="viewbyd">
                          <Link to="javascript:;" className="view-support">View</Link>
                          <div className="issue-btns">
                            <Link to="javascript:;" className="active">Weekly</Link>
                            <Link to="javascript:;">Monthly</Link>
                            <Link to="javascript:;">Yearly</Link>
                            <Link to="javascript:;">Custom</Link>
                          </div>
                        </div>
                        <div className="time-frame">
                          <span>Timeframe <input type="date" name="form-control" placeholder="14 October to 20 October 2024"/>
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="main-stats-box">
                      <div className="row admin-dash-stats">
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Revenue</h6>
                            <div className="average-score">
                              <h5>£3.600.00</h5>
                              <span>+4.2% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                            </div>
                            <span className="compared-weeks">Compared to (last month)</span>
                          </div>
                        </div>
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Expenses</h6>
                            <div className="average-score">
                              <h5>1.002</h5>
                              <span>+2.5% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                            </div>
                            <span className="compared-weeks">Compared to (last month)</span>
                          </div>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Total Vehicles</h6>
                            <div className="average-score">
                              <h5>32</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                                </svg>
                              </span>
                            </div>
                            <span className="compared-weeks">Compared to (last month)</span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap brdrnn">
                            <h6 className="vehicle-average-title">Vehicles Rented</h6>
                            <div className="average-score">
                              <h5>32</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                      ...
                      <div className="row admin-dash-stats">
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Utilisation Rate</h6>
                            <div className="average-score">
                              <h5>100 %</h5>
                              <span>+4.2% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Average Rental Duration</h6>
                            <div className="average-score">
                              <h5>3 Days</h5>
                              <span>+2.5% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">New Driver Registrations</h6>
                            <div className="average-score">
                              <h5>12</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                            ...
                            <span className="compared-weeks">Maintenance Schedule Alerts</span>
                          </div>
                        </div>
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap brdrnn">
                      ...
                      <div className="row admin-dash-stats">
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Complaint and Issue Report</h6>
                            <div className="average-score">
                              <h5>13</h5>
                              <span>+4.2% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Insurance Claims</h6>
                            <div className="average-score">
                              <h5>3</h5>
                              <span>+2.5% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Fleet Age distribution</h6>
                            <div className="average-score">
                              <h5>12</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap brdrnn">
                            <h6 className="vehicle-average-title">Retention Period</h6>
                            <div className="average-score">
                              <h5>32</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                      ...
                      <div className="row admin-dash-stats">
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Website Analytics</h6>
                            <div className="average-score">
                              <h5>13</h5>
                              <span>+4.2% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Pending Approvals / Verification</h6>
                            <div className="average-score">
                              <h5>3</h5>
                              <span>+2.5% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Outstanding Fines and Penalties</h6>
                            <div className="average-score">
                              <h5>12</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                        ...
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap brdrnn">
                            <h6 className="vehicle-average-title">Profit Margins</h6>
                            <div className="average-score">
                              <h5>32</h5>
                              <span className="red-clr">-2.2% <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.0035 14C8.18921 14.0009 8.37523 13.9249 8.50883 13.772L13.1688 8.43865C13.4111 8.16139 13.3827 7.74023 13.1055 7.49797C12.8282 7.25571 12.4071 7.28409 12.1648 7.56135L8.66682 11.5647L8.66682 2.66667C8.66682 2.29848 8.36834 2 8.00015 2C7.63196 2 7.33349 2.29848 7.33349 2.66667L7.33349 11.5533L3.83489 7.56064C3.59224 7.28372 3.17105 7.25594 2.89413 7.49859C2.61721 7.74124 2.58943 8.16244 2.83208 8.43936L7.44845 13.7077C7.56839 13.8841 7.77074 14 8.00015 14C8.00127 14 8.00238 14 8.0035 14Z" fill="#6E7074" />
                      ...
                      <div className="row admin-dash-stats brdrnn">
                        <div className="col-lg-3 col-md-3">
                          <div className="vehicle-average-wrap">
                            <h6 className="vehicle-average-title">Upcoming Bookings</h6>
                            <div className="average-score">
                              <h5>13</h5>
                              <span>+4.2% <ion-icon name="arrow-up-outline" role="img" className="md hydrated"></ion-icon>
                              </span>
                    ...
                    <div className="stats-graph">
                      <img src="./admin_assets/images/ssdsds.png" alt="Sales-statistics"/>
                    </div>
                  </div>
                </div>
              </div>
...
<Modal show={show} onHide={handleClose} animation={false} className='password_modal'>
<ModalBody>
...
<div className="col-md-4">
  <div className="cstmr-bx">
      <div className="cstmr-mn-deta">
         <img src="./admin_assets/images/customer2.png" alt="customer2"/>
         <div className="c_nm">
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12">
              <div className="form-group">
                ...
                <br/>
                <input type="text" name="form-control" placeholder="BTR123412"/>
              </div>
            </div>
            <div className="col-lg-12 col-md-12">
              <div className="form-group">
                ...
                <br/>
                <input type="text" name="form-control" placeholder="Ron.don@gmail.com "/>
              </div>
            </div>
            <div className="col-lg-12 col-md-12">
              <div className="form-group">
                <label for="control-label">Phone Number</label>
                <input type="number" name="form-control" id="" className="mg0" placeholder="+44  123 123 123"/>
              </div>
            </div>
          </div>
        </form> 
  ...
  <div className="vehical-bx">
      <div className="veh-head">
          <h4>Vehicle</h4>
          <Link to="javascript:;" className="active-btn"><svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" viewBox="0 0 9 8" fill="none"><circle cx="4.5" cy="4" r="3" fill="white"></circle></svg>Active</Link>
      </div>
      <div className="vehicle-img">
          <img src="./admin_assets/images/car1212.png" alt="car1212"/>
      </div>
      <div className="car-details">
          <h6>Mercedes-Benz E-Class</h6>
          <p>2019</p>
          <span>26 April at 16:05</span><svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" viewBox="0 0 9 8" fill="none"><circle cx="4.5" cy="4" r="3" fill="white"></circle></svg><span>KE19 OJS</span>
      </div>
  </div> 
</div>
...
<div className="unpaid-pp-btns">
     ...
     <Link to="javascript:;" className="delete-btn" onClick={handleShowdelete}>Delete</Link>
     <Link to="javascript:;" className="try-payment-btn" onClick={handleShowpayment}>Try Payment</Link>
</div>
</div>
</div>
</div>
...
<Modal show={showamend} onHide={handleCloseamend} animation={false} className='password_modal'>
<ModalBody>
<div className="unpaid-pp amend-pp">
<button className="close-btn" onClick={handleCloseamend}>×</button>
<div className="row innr-row">
<div className="col-md-4">
  <div className="cstmr-bx">
      <div className="cstmr-mn-deta">
...
<div className="amend-pp-btns">
     <Link to="javascript:;" className="cancel-btn" onClick={handleCloseamend}>Cancel</Link>
...
<Modal show={showdelete} onHide={handleClosedelete} animation={false} className='password_modal'>
<ModalBody>
...
<div className="alrt-deta">
   ...
   <p>This action cannot be undone”. When this is deleted, it soft deletes and it can be recovered.</p>
   <div className="alrt-btns">
       <Link to="javascript:;" className="cancel-btn" onClick={handleClosedelete}>Cancel</Link>
       <Link to="javascript:;" className="yes-btn" onClick={handleClosedelete}>Yes</Link>
   </div>
</div>
</div>
</ModalBody>
...
<Modal show={showpayment} onHide={handleClosepayment} animation={false} className='password_modal'>
    <ModalBody>
...
<div className="card-innr-blk">
    ...
    <h4>Select a Card</h4>
    <Link to="javascript:;" onClick={handleShowaddpayment}><img src="./admin_assets/images/plus.png" className="plus-img" alt="comm"/>Add Card</Link>
    </div>
                    ...
                    <label className="checkbox payment-radio">
                        ...
                        <div className="checkbox__body">
                            <div className="checkbox-inbody">
                                <img src="./admin_assets/images/dashboard/Visa_Inc._logo 1.svg" alt=""/>
                                <div>
            ...
            <div className="payment-options-list payment-options2">
                <div className="checkboxes__item">
                    <label className="checkbox payment-radio">
                        ...
                        <div className="checkbox__body">
                            <div className="checkbox-inbody">
                                <img src="./admin_assets/images/dashboard/mc.svg" alt=""/>
                                <div>
                                    <h6>Visa Ending in 1231</h6>
                                    <span className="exp">Expired date 12/24</span>
                                </div>
...
<Modal show={showaddpayment} onHide={handleCloseaddpayment} animation={false} className='password_modal'>
    <ModalBody>
<div className="cardpay-popup_bx">
<div className="card-main-head">
    <h2>Confirmation Payment</h2>
...
<div className="card-innr-blk">
    <div className="card-selection">
    <h4>Select a Card</h4>
    <Link to="javascript:;"><img src="./admin_assets/images/plus.png" className="plus-img" alt="comm"/>Add Card</Link>
    </div>
    <div className="payment-method-wrapper">
        <form action="">
            <div className="payment-options-list payment-options1">
    ...
    <div className="payment-card-wrapper">
        <img src="./admin_assets/images/dashboard/card1.png" alt="card"/>
    </div>
    ...
    <form action="">
        <div className="debit-card-wrap">
            <div className="debit-card-title">
                <h6>Debit Card</h6>
                <img src="./admin_assets/images/dashboard/Visa.png" alt="Visa"/>
            </div>
            <div className="row">
                <div className="col-lg-12 col-md-12">
                    <div className="form-group">
...
<div className="card-pay-action-btns">
    <Link to="javascript:;" className="cancel-btn" onClick={handleCloseaddpayment}>Cancel</Link>
    <Link to="javascript:;" className="payment-btn" onClick={handleCloseaddpayment}>Payment</Link>
</div>
</div>
</ModalBody>
</Modal>
...
<div className="alrt-deta">
   ...
   <table>
       ...
       <tr>
           ...
           <td className="status-tagbtns"><Link to="javascript:;" className="completed-btn"><svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" viewBox="0 0 9 8" fill="none"><circle cx="4.5" cy="4" r="3" fill="white"></circle></svg>Completed</Link></td>
       </tr>
   </table>
...
<div className="alrt-deta">
   ...
   <div className="failed-alert">
      <img src="./admin_assets/images/Error.png" className="Error-img" alt="Error-img"/>
