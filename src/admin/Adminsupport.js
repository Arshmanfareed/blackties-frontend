                                                ...
                                                <div className="outstanding-txt">
                                                    ...
                                                    <div className="support-num-perctgre">
                                                        ...
                                                        <div className="suprt-percantage">
                                                            <h3>+4.2% <i className="fas fa-arrow-up"></i></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-12 col-md-12">
                                            <div className="support-issue-main-bx">
                                                <div className="support-issue-head">
                                                    <h4>Support & Issue</h4>
                                                        <Link to="#" className="view-support">View</Link>
                                                    <div className="issue-btns">
                                                        <Link to="#" className="active">Weekly</Link>
                                                        <Link to="#">Monthly</Link>
                                                        <Link to="#">Yearly</Link>
                                                        <Link to="#">Custom</Link>
                                                    </div>
                                                    <div className="time-frame">
                                                        <span>Timeframe<input type="date" name="form-control" placeholder="14 October to 20 October 2024"/></span>
                                                    </div>
                                                    <div className="tivcket-btn">
                                                        <Link to="/admin-support-create-ticket"><i className="fas fa-plus"></i>Add Ticket</Link>
                                                    </div>
                                                </div>
                                            <div className="tabs-container">
                                                ...
                                                <div className="vehicle-tabs support-issue-tabs">
                                                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="nav-link  active" id="All-tab" data-bs-toggle="tab" to="#All" role="tab" aria-controls="All" aria-selected="true">All</Link>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="nav-link" id="New-tab" data-bs-toggle="tab" to="#New" role="tab" aria-controls="New" aria-selected="false">New</Link>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="nav-link" id="Open-tab" data-bs-toggle="tab" to="#Open" role="tab" aria-controls="Open" aria-selected="false">Open</Link>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="nav-link" id="Pending-tab" data-bs-toggle="tab" to="#Pending" role="tab" aria-controls="Pending" aria-selected="false">Pending</Link>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="nav-link" id="Resolved-tab" data-bs-toggle="tab" to="#Resolved" role="tab" aria-controls="Resolved" aria-selected="false">Resolved</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div className="tab-content" id="myTabContent">
                                                        ...
                                                        <table className="maintenance-table ds-table veh-history-tble adm-user-tble pcn-tble supp-issue">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>Mercedes E220</td>
                                                                    <td>Queries</td>
                                                                    <td className="High-btn"><Link to="#">High</Link></td>
                                                                    <td className="New-btn"><Link to="#">New</Link></td>
                                                                    <td className="tb-btn2"><Link to="#"><i class="fa-solid fa-ellipsis-vertical"></i></Link></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>ADA2142</td>
                                                                    <td>27 June, 2024 10:00 AM</td>
                                                                    ...
                                                                    <td>Mercedes E220</td>
                                                                    <td>Complaints</td>
                                                                    <td className="Medium-btn"><Link to="#">Medium</Link></td>
                                                                    <td className="Resolved-btn"><Link to="#">Resolved</Link></td>
                                                                    <td className="tb-btn2"><Link to="#"><i class="fa-solid fa-ellipsis-vertical"></i></Link></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>ADA2142</td>
                                                                    ...
                                                                    <td className="Low-btn"><Link to="#">Low</Link></td>
                                                                     <td className="Open-btn"><Link to="#">Open</Link></td> 
                                                    ...
                                                    <div className="tab-pane fade" id="Resolved" role="tabpanel" aria-labelledby="Resolved-tab">
                                                        <table className="maintenance-table ds-table veh-history-tble adm-user-tble pcn-tble supp-issue">
                                                            <thead>
                                                                <tr>
                                                                    <th>Ticket ID</th>
