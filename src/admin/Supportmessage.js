                                    ...
                                    <div className="row">
                                                <div className="chat-board-topBar">
                                                    <div className="chat-user-profile">
                                                        <img src="./admin_assets/images/dashboard/Avatar.png" alt="user profile"/>
                                                        <h6>Jenny Wilson</h6>
                                                    </div>
                                                    <div className="chat-XOptions">
                                                        <Link to="#" className="chat-fav"><img src="./admin_assets/images/dashboard/Vector532.png"/></Link>
                                                        <Link to="#" className="chat-copen"><img src="./admin_assets/images/dashboard/Coupon3432.png"/></Link>
                                                        <Link to="#" className="chat-sleep"><img src="./admin_assets/images/dashboard/Group533.png"/></Link>
                                                        <Link to="#" className="chat-sleep"><img src="./admin_assets/images/envolope.png"/></Link>
                                                        <Link to="#" className="chat-sleep"><img src="./admin_assets/images/download.png"/></Link>
                                                        <Link to="#" className="chat-option"><i className="fa-solid fa-ellipsis"></i></Link>
                                                        <Link to="#" className="chat-close"><img src="./admin_assets/images/dashboard/Vector4354.png"/> Close</Link>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-5 col-md-5">
                                            <div className="details-colmn">
                                                ...
                                                <div className="details-column-txt">
                                                    ...
                                                    <div className="code-id">
                                                        <p><Link to="#" className="Open-btn">Open</Link></p>
                                                    </div>
                                                </div>
                                                 <div className="details-column-txt">
                                                    <div className="tckt-txt">
                                                    ...
                                                    <div className="code-id">
                                                        <p><Link to="#" className="High-btn">High</Link></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="user-head-text">
                                                    <h5>User Notes</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur. Nascetur amet leo in sed quisque neque. Venenatis massa sit eleifend amet et sed ipsum eget. Massa convallis vitae consequat eu sagittis luctus nunc sit.</p>
                                                </div>
                                                <div className="user-head-text">
                                                    <h5>Company Notes</h5>
                                                    <p>Lorem ipsum dolor sit amet consectetur. Nascetur amet leo in sed quisque neque. Venenatis massa sit eleifend amet et sed ipsum eget. Massa convallis vitae consequat eu sagittis luctus nunc sit.</p>
                                                ...
                                                <div className="message-resolved-btn">
                                                    <Link to="#" className="msg-resolve-btn">Resolved</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
