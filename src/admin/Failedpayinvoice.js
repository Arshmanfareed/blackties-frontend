                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12">
                            <div className="invoice-view-sec db-default-sec">
                                <div className="invoice-view-card db-default-wrapper admin-invoice-view-card admin-invoice-pay-card admin-amended-invoice-pay-card admin-amended-invoice-retry">
                                    <div className="row">
                                        <div className="col-lg-12 col-md-12">
                                                ...
                                                <Link to="#" className="back-to"><i class="fas fa-chevron-left"></i> Back to Invoice</Link>
                                                    <div className="admin-invoice-view-card-btns">
                                                        <div className="admin-invoice-main-btn">
                                                            <Link to="#" className="re-send-email-btn">Send Email</Link>
                                                            <Link to="#" className="amand-btn">Amand</Link>
                                                            <Link to="#" className="retry-pay-btn">Retry Payment</Link>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
...
export default Failedpayinvoice
